...
public class Buyer {
    ...
    public void showBuyer() {
    	...
    	System.out.println("현재 소지금 :" + this.money+", 현재 망고개수 : "+ this.mango);
    }
    ...
    public void buyMango(Seller seller, int mango) {
    	...
    	// Seller 쪽 망고 재고를 Buyer쪽에서 미리 아는 방법은
    	...
    	if(seller.getMango()< mango) {
    		System.out.println("망고 재고가 부족해서 거래가 불가능 합니다. 망고재료 :"+seller.getMango());
    	return;	
    	}
